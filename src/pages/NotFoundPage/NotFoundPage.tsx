...
export function NotFoundPage() {
	...
	return (
		<Container className='flex min-h-[calc(100vh-200px)] flex-col items-center justify-center px-4 text-center sm:px-6 md:px-8'>
			<h1 className='text-primary mb-6 text-6xl font-bold sm:mb-8 sm:text-7xl md:text-8xl lg:text-9xl'>404</h1>
			<h2 className='mb-4 text-xl font-semibold text-gray-800 sm:text-2xl md:text-3xl'>Страница не найдена</h2>
